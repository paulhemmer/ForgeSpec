...
This document describes the **Controlled Implementation Loop (CIL)**: optional, recommended operational discipline for implementation after architecture and specs are stable. It applies whether implementation is **human-only**, **AI-assisted**, or mixed.
...
**Controlled Implementation Loop (CIL):** A structured, repeatable loop for executing implementation in bounded, traceable, reviewable steps derived from the spec and `docs/IMPLEMENTATION_PLAN.md`.
