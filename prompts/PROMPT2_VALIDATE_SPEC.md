...
6. Narrative and task coverage
   - If the original project narrative (or discovery summary) was provided: verify that the spec addresses the key capabilities, action verbs, and requirements from that narrative.
...
• identify the affected spec section
• recommend minimal spec improvements
